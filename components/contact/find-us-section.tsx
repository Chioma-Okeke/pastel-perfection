        ...
        <section className="py-16 lg:py-24">
            <PaddingContainer>
                <MaxContainer className="space-y-10 lg:space-y-14">
                    <AnimatedSection className="space-y-4 max-w-2xl">
                    ...
                    <div className="grid gap-10 lg:grid-cols-[2fr_3fr] lg:gap-16">
                        ...
                        <AnimatedSection className="relative w-full h-96 lg:h-auto">
                            <motion.div
                                whileHover={{ scale: 1.01, transition: { duration: 0.25, ease: "easeOut" } }}
                                className="relative h-full w-full overflow-hidden bg-accent/8 bg-[linear-gradient(to_right,var(--color-border)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-border)_1px,transparent_1px)] bg-size-[56px_56px]"
                            >
