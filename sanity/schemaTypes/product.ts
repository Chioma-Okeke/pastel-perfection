...
const PRODUCT_TYPE_OPTIONS = ['Pads', 'Hand Cream', 'Face Cream', 'Serum', 'Body Lotion', 'Bar Soap', 'Oil', 'Shower Gel', 'Body Scrubs', "Facial Wash", "Sunscreen", "Eye Cream", "Body Treatment Cream", "Facial Cleanser", "Toner", "Facial Masks", "Peeling Oil"]
